...
namespace emul
{
	...
	void CPU6809::Init()
	{
		...
		m_opcodes[0x05] = [=]() { MEMopR(&CPU6809::ORA, GetZP()); }; // zp
		m_opcodes[0x15] = [=]() { MEMopR(&CPU6809::ORA, GetZPX()); }; // zpx
		m_opcodes[0x01] = [=]() { MEMopR(&CPU6809::ORA, GetINDX()); }; // izx
		m_opcodes[0x11] = [=]() { MEMopR(&CPU6809::ORA, GetINDY()); }; // izy
		m_opcodes[0x0D] = [=]() { MEMopR(&CPU6809::ORA, GetABS()); }; // abs
		m_opcodes[0x1D] = [=]() { MEMopR(&CPU6809::ORA, GetABSX()); }; // abx
		m_opcodes[0x19] = [=]() { MEMopR(&CPU6809::ORA, GetABSY()); }; // aby

		// AND A:=A and {adr}, NZ
		m_opcodes[0x29] = [=]() { AND(FetchByte()); }; // imm
		m_opcodes[0x25] = [=]() { MEMopR(&CPU6809::AND, GetZP()); }; // zp
		m_opcodes[0x35] = [=]() { MEMopR(&CPU6809::AND, GetZPX()); }; // zpx
		m_opcodes[0x21] = [=]() { MEMopR(&CPU6809::AND, GetINDX()); }; // izx
		m_opcodes[0x31] = [=]() { MEMopR(&CPU6809::AND, GetINDY()); }; // izy
		m_opcodes[0x2D] = [=]() { MEMopR(&CPU6809::AND, GetABS()); }; // abs
		m_opcodes[0x3D] = [=]() { MEMopR(&CPU6809::AND, GetABSX()); }; // abx
		m_opcodes[0x39] = [=]() { MEMopR(&CPU6809::AND, GetABSY()); }; // aby

		// EOR A:=A xor {adr}, NZ
		m_opcodes[0x49] = [=]() { EOR(FetchByte()); }; // imm
		m_opcodes[0x45] = [=]() { MEMopR(&CPU6809::EOR, GetZP()); }; // zp
		m_opcodes[0x55] = [=]() { MEMopR(&CPU6809::EOR, GetZPX()); }; // zpx
		m_opcodes[0x41] = [=]() { MEMopR(&CPU6809::EOR, GetINDX()); }; // izx
		m_opcodes[0x51] = [=]() { MEMopR(&CPU6809::EOR, GetINDY()); }; // izy
		m_opcodes[0x4D] = [=]() { MEMopR(&CPU6809::EOR, GetABS()); }; // abs
		m_opcodes[0x5D] = [=]() { MEMopR(&CPU6809::EOR, GetABSX()); }; // abx
		m_opcodes[0x59] = [=]() { MEMopR(&CPU6809::EOR, GetABSY()); }; // aby

		// ADC A:=A + {adr}, NVZC
		m_opcodes[0x69] = [=]() { ADC(FetchByte()); }; // imm
		m_opcodes[0x65] = [=]() { MEMopR(&CPU6809::ADC, GetZP()); }; // zp
		m_opcodes[0x75] = [=]() { MEMopR(&CPU6809::ADC, GetZPX()); }; // zpx
		m_opcodes[0x61] = [=]() { MEMopR(&CPU6809::ADC, GetINDX()); }; // izx
		m_opcodes[0x71] = [=]() { MEMopR(&CPU6809::ADC, GetINDY()); }; // izy
		m_opcodes[0x6D] = [=]() { MEMopR(&CPU6809::ADC, GetABS()); }; // abs
		m_opcodes[0x7D] = [=]() { MEMopR(&CPU6809::ADC, GetABSX()); }; // abx
		m_opcodes[0x79] = [=]() { MEMopR(&CPU6809::ADC, GetABSY()); }; // aby

		// SBC A:=A - {adr}, NVZC
		m_opcodes[0xE9] = [=]() { SBC(FetchByte()); }; // imm
		m_opcodes[0xE5] = [=]() { MEMopR(&CPU6809::SBC, GetZP()); }; // zp
		m_opcodes[0xF5] = [=]() { MEMopR(&CPU6809::SBC, GetZPX()); }; // zpx
		m_opcodes[0xE1] = [=]() { MEMopR(&CPU6809::SBC, GetINDX()); }; // izx
		m_opcodes[0xF1] = [=]() { MEMopR(&CPU6809::SBC, GetINDY()); }; // izy
		m_opcodes[0xED] = [=]() { MEMopR(&CPU6809::SBC, GetABS()); }; // abs
		m_opcodes[0xFD] = [=]() { MEMopR(&CPU6809::SBC, GetABSX()); }; // abx
		m_opcodes[0xF9] = [=]() { MEMopR(&CPU6809::SBC, GetABSY()); }; // aby

		// CMP A - {adr}, NZC
		m_opcodes[0xC9] = [=]() { CMPA(FetchByte()); }; // imm
		m_opcodes[0xC5] = [=]() { MEMopR(&CPU6809::CMPA, GetZP()); }; // zp
		m_opcodes[0xD5] = [=]() { MEMopR(&CPU6809::CMPA, GetZPX()); }; // zpx
		m_opcodes[0xC1] = [=]() { MEMopR(&CPU6809::CMPA, GetINDX()); }; // izx
		m_opcodes[0xD1] = [=]() { MEMopR(&CPU6809::CMPA, GetINDY()); }; // izy
		m_opcodes[0xCD] = [=]() { MEMopR(&CPU6809::CMPA, GetABS()); }; // abs
		m_opcodes[0xDD] = [=]() { MEMopR(&CPU6809::CMPA, GetABSX()); }; // abx
		m_opcodes[0xD9] = [=]() { MEMopR(&CPU6809::CMPA, GetABSY()); }; // aby

		// CPX
		m_opcodes[0xE0] = [=]() { CMPX(FetchByte()); }; // imm
		m_opcodes[0xE4] = [=]() { MEMopR(&CPU6809::CMPX, GetZP()); }; // zp
		m_opcodes[0xEC] = [=]() { MEMopR(&CPU6809::CMPX, GetABS()); }; // abs

		// CPY
		m_opcodes[0xC0] = [=]() { CMPY(FetchByte()); }; // imm
		m_opcodes[0xC4] = [=]() { MEMopR(&CPU6809::CMPY, GetZP()); }; // zp
		m_opcodes[0xCC] = [=]() { MEMopR(&CPU6809::CMPY, GetABS()); }; // abs

		// DEC {adr}:={adr}-1, NZ
		m_opcodes[0xC6] = [=]() { MEMopRMW(&CPU6809::DEC, GetZP()); }; // zp
		m_opcodes[0xD6] = [=]() { MEMopRMW(&CPU6809::DEC, GetZPX()); }; // zpx
		m_opcodes[0xCE] = [=]() { MEMopRMW(&CPU6809::DEC, GetABS()); }; // abs
		m_opcodes[0xDE] = [=]() { MEMopRMW(&CPU6809::DEC, GetABSX()); }; // abx
		...
		// INC {adr}:={adr}+1, NZ
		m_opcodes[0xE6] = [=]() { MEMopRMW(&CPU6809::INC, GetZP());  }; // zp
		m_opcodes[0xF6] = [=]() { MEMopRMW(&CPU6809::INC, GetZPX()); }; // zpx
		m_opcodes[0xEE] = [=]() { MEMopRMW(&CPU6809::INC, GetABS()); }; // abs
		m_opcodes[0xFE] = [=]() { MEMopRMW(&CPU6809::INC, GetABSX()); }; // abx
		...
		m_opcodes[0x06] = [=]() { MEMopRMW(&CPU6809::ASL, GetZP()); }; // zp
		m_opcodes[0x16] = [=]() { MEMopRMW(&CPU6809::ASL, GetZPX()); }; // zpx
		m_opcodes[0x0E] = [=]() { MEMopRMW(&CPU6809::ASL, GetABS()); }; // abs
		m_opcodes[0x1E] = [=]() { MEMopRMW(&CPU6809::ASL, GetABSX()); }; // abx

		// ROL {adr}:={adr}*2+C, NZC
		m_opcodes[0x2A] = [=]() { ROL(m_reg.A); }; // imp
		m_opcodes[0x26] = [=]() { MEMopRMW(&CPU6809::ROL, GetZP()); }; // zp
		m_opcodes[0x36] = [=]() { MEMopRMW(&CPU6809::ROL, GetZPX()); }; // zpx
		m_opcodes[0x2E] = [=]() { MEMopRMW(&CPU6809::ROL, GetABS()); }; // abs
		m_opcodes[0x3E] = [=]() { MEMopRMW(&CPU6809::ROL, GetABSX()); }; // abx

		// LSR {adr}:={adr}/2, NZC
		m_opcodes[0x4A] = [=]() { LSR(m_reg.A); }; // imp
		m_opcodes[0x46] = [=]() { MEMopRMW(&CPU6809::LSR, GetZP()); }; // zp
		m_opcodes[0x56] = [=]() { MEMopRMW(&CPU6809::LSR, GetZPX()); }; // zpx
		m_opcodes[0x4E] = [=]() { MEMopRMW(&CPU6809::LSR, GetABS()); }; // abs
		m_opcodes[0x5E] = [=]() { MEMopRMW(&CPU6809::LSR, GetABSX()); }; // abx

		// ROR {adr}:={adr}/2+(C*128), NZC
		m_opcodes[0x6A] = [=]() { ROR(m_reg.A); }; // imp
		m_opcodes[0x66] = [=]() { MEMopRMW(&CPU6809::ROR, GetZP()); }; // zp
		m_opcodes[0x76] = [=]() { MEMopRMW(&CPU6809::ROR, GetZPX()); }; // zpx
		m_opcodes[0x6E] = [=]() { MEMopRMW(&CPU6809::ROR, GetABS()); }; // abs
		m_opcodes[0x7E] = [=]() { MEMopRMW(&CPU6809::ROR, GetABSX()); }; // abx
		...
		// SLO: ASL + ORA
		m_opcodes[0x07] = [=]() { MEMopRMW(&CPU6809::SLO, GetZP()); }; // zp
		m_opcodes[0x17] = [=]() { MEMopRMW(&CPU6809::SLO, GetZPX()); }; // zpx
		m_opcodes[0x03] = [=]() { MEMopRMW(&CPU6809::SLO, GetINDX()); }; // izx
		m_opcodes[0x13] = [=]() { MEMopRMW(&CPU6809::SLO, GetINDY()); }; // izy
		m_opcodes[0x0F] = [=]() { MEMopRMW(&CPU6809::SLO, GetABS()); }; // abs
		m_opcodes[0x1F] = [=]() { MEMopRMW(&CPU6809::SLO, GetABSX()); }; // abx
		m_opcodes[0x1B] = [=]() { MEMopRMW(&CPU6809::SLO, GetABSY()); }; // aby

		// ISC: INC + SBC
		m_opcodes[0xE7] = [=]() { MEMopRMW(&CPU6809::ISC, GetZP());  }; // zp
		m_opcodes[0xF7] = [=]() { MEMopRMW(&CPU6809::ISC, GetZPX()); }; // zpx
		m_opcodes[0xEF] = [=]() { MEMopRMW(&CPU6809::ISC, GetABS()); }; // abs
		m_opcodes[0xFF] = [=]() { MEMopRMW(&CPU6809::ISC, GetABSX()); }; // abx
	...
	void CPU6809::ClearFlags(BYTE& flags)
	{
		flags = FLAG_RESERVED_ON;
	}

	void CPU6809::SetFlags(BYTE f)
	{
	...
	void CPU6809::MEMopRMW(std::function<void(CPU6809*, BYTE&)> func, ADDRESS dest)
	{
	...
	void CPU6809::MEMopR(std::function<void(CPU6809*, BYTE)> func, ADDRESS oper)
	{
	...
	void CPU6809::LD(BYTE& dest, BYTE src)
	{
		dest = src;
		AdjustNZ(dest);
	}

	void CPU6809::LDmem(BYTE& dest, ADDRESS src)
	{
		dest = m_memory.Read8(src);
		AdjustNZ(dest);
	}

	void CPU6809::STmem(ADDRESS dest, BYTE src)
	{
	...
	void CPU6809::BRANCHif(bool cond)
	{
	...
	void CPU6809::JMP(ADDRESS dest)
	{
		m_programCounter = dest;
	}

	void CPU6809::BIT(ADDRESS src)
	{
	...
	void CPU6809::ORA(BYTE oper)
	{
		m_reg.A |= oper;
		AdjustNZ(m_reg.A);

	}
	void CPU6809::AND(BYTE oper)
	{
		m_reg.A &= oper;
		AdjustNZ(m_reg.A);
	}
	void CPU6809::EOR(BYTE oper)
	{
		m_reg.A ^= oper;
		AdjustNZ(m_reg.A);
	}

	BYTE CPU6809::addSubBinary(BYTE oper, bool carry)
	{
		BYTE oldA = m_reg.A;
		WORD temp = oldA + oper;
		if (carry)
	...
	BYTE CPU6809::addBCD(BYTE oper, bool carry)
	{
		BYTE oldA = m_reg.A;
	...
	BYTE CPU6809::subBCD(BYTE oper, bool carry)
	{
	...
	void CPU6809::SLO(BYTE& dest)
	{
		ASL(dest);
		ORA(dest);
	}

	void CPU6809::ISC(BYTE& dest)
	{
		INC(dest);
		SBC(dest);
	}
